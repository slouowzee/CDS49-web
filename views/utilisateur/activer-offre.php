<main class="container mt-5 pt-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <?php elseif (isset($step) && $step === 'confirm_choice_not_connected'): ?>
                <!-- Première confirmation pour utilisateur non connecté -->
                <div class="text-center">
                    <h2 class="mb-4">Confirmer votre choix</h2>
                    ...
                    <p class="mb-3">Confirmez-vous votre choix de ce forfait ?</p>
                    <p class="text-muted mb-4">Vous serez ensuite redirigé vers la connexion</p>
                    
                    <div class="mt-3">
                        <form method="POST" action="/activer-offre.html" class="d-inline">
                            <input type="hidden" name="confirm_choice" value="1">
            ...
            <?php elseif (isset($step) && $step === 'confirm_activation_connected'): ?>
                <!-- Confirmation finale pour utilisateur connecté -->
                <div class="text-center">
                    <h2 class="mb-4">Confirmer l'activation</h2>
                    ...
                    <p class="mb-4">Voulez-vous activer ce forfait ?</p>
                    
                    <form method="POST">
                        <button type="submit" class="btn btn-success me-2">✓ Activer</button>
                        <a href="/forfaits.html" class="btn btn-secondary">Annuler</a>
                    </form>
                </div>
            ...
            <?php else: ?>
                ...
                <div class="text-center">
                    <div class="bg-warning text-dark rounded p-4 mb-4">
                        <h2>⚠ Erreur</h2>
                        <p class="mb-0">Une erreur est survenue</p>
                    </div>
                    <a href="/forfaits.html" class="btn btn-primary">Retour aux Forfaits</a>
